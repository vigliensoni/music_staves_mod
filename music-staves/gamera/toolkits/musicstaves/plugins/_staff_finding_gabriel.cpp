  ...
  using namespace Gamera;
      ...
      extern "C" {
#ifndef _MSC_VER
    void init_staff_finding_gabriel(void);
#endif
          ...
          static PyMethodDef _staff_finding_gabriel_methods[] = {
...
return 0;
  ...
  DL_EXPORT(void) init_staff_finding_gabriel(void) {
    Py_InitModule(CHAR_PTR_CAST "_staff_finding_gabriel", _staff_finding_gabriel_methods);
  }
